...
- **Tutorials** — Lorenz-96 twin experiment; paleoclimate OSSE with
  synthetic coral proxies.
...
The [`reproduce/`](reproduce/) directory contains one script per figure
in the paper above, reading from a Zenodo data deposit (DOI to be
assigned at acceptance). After installing `pypfda`:
